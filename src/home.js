  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="news">
          <div className="newsheading">{lang.newsheading}<br></br></div>
          <div className="newsText">{lang.newsText}</div>
            <figure>
              <img src="http://www.stiftelsen-uni.no/r/img/P2191.jpg" id="news-image">
                <figcaption>{lang.newsSource}</figcaption>
              </img>
            </figure>
        </div>
        <div>
