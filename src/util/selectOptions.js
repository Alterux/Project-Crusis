...
let inputUserType = () => { return (
  <select className="form formUserType" id="inputUserType" ref="inputUserType" required>
...
let inputDays = () => { return (
  <select className="form formBirth" id="inputBirthDay" ref="inputBirthDay" required>
...
let inputMonths = () => { return (
  <select className="form formBirth" id="inputBirthMonth" ref="inputBirthMonth" required>
...
let inputYears = () => { return (
  <select className="form formBirth" id="inputBirthYear" ref="inputBirthYear" required>
...
export { inputDays, inputMonths, inputYears, inputUserType };
